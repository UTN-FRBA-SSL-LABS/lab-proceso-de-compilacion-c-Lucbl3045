...
> **R:**
 Porque tambien estan los elementos agregados de los include
---
...
> **R:**
Porque los comentarios son eleminiados por el preprocesador
---
...
> **R:**
prólogo estándar de una función en ensamblador x86-64 (generalmente generado por GCC o Clang) y se encargan de preparar la pila (stack) y establecer la información necesaria para la depuración y el manejo de excepciones.
---
...
> **R:**Porque en uno esta definido y en el otro no.
...
> **R:**
Porque hay bibliotecas que se cargan en ejecucion y las resuelve el cargador dinamicos
---
...
> **R:** Varian en cuando se ejecutan, la macro es en preprocesamiento mientras la otra recien se llama en tiempos de compilacion.
...
> **R:** En que una radica a la seccion ejecutable y la otra en la dinamica.
...
> **R:**
    linux-vdso.so.1 (0x00007ffc92f81000)
    libc.so.6 => /lib/x86_64-linux-gnu/libc.so.6 (0x00007fc2a1800000)
    /lib64/ld-linux-x86-64.so.2 (0x00007fc2a1c2b000)



¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:** porque es libreria estandar de C
